    ...
    public class MusicsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string musicGenre, string searchString)
        {
            ...
            var musicGenreVM = new MusicGenreViewModel
            {
                ...
                MusicList = await music.ToListAsync()
            };
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Artist,ReleaseDate,Genre,Price")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Artist,ReleaseDate,Genre,Price")] Music music)
        {
            if (id != music.Id)
            {
                return NotFound();
