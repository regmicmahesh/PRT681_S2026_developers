...
namespace DreamSales.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,Quantity")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,Quantity")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
