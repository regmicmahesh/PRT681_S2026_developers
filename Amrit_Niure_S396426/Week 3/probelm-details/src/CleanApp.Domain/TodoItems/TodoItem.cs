...
public sealed class TodoItem : AggregateRoot<TodoItemId>
{
    ...
    private TodoItem(TodoItemId id, TodoListId todoListId, TodoItemTitle title, PriorityLevel priority, DateTime? reminderUtc)
        : base(id)
    {
        ...
        string? note = null)
    {
        ...
        var item = new TodoItem(TodoItemId.New(), todoListId, titleResult.Value, priorityResult.Value, reminderUtc)
        {
            Note = note
        };
